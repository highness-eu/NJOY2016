...
extern "C" 
{
  void generate_bragg_edges(char* s, int* nbragg, double* data, double* current_temp, int* maxb, unsigned int* atomic_z, unsigned int* atomic_a, double* c_incoherent_bound_xs, double* c_coherent_bound_xs, double* c_spr, double* c_ncrystal_msd);
}
